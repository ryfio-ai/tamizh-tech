/**
 * Pushes exactly 1 complete sample row into all 9 tabs of the Google Sheet:
 * 1. Product Enquiries
...
const MOCK_DATA = [
  // 1. Product Enquiries
  {
    ...
    leadId: "TT-PROD-2026-001",
    submittedAt: "03/09/2026, 4:40:00 pm",
  ...
  // 2. Course Enrollments
  {
    ...
    leadId: "TT-CRS-2026-001",
    submittedAt: "03/09/2026, 4:41:00 pm",
  ...
  // 3. School Enquiries
  {
    ...
    leadId: "TT-SCH-2026-001",
    submittedAt: "03/09/2026, 4:42:00 pm",
  ...
  // 4. College Enquiries
  {
    ...
    leadId: "TT-COL-2026-001",
    submittedAt: "03/09/2026, 4:43:00 pm",
  ...
  // 5. Industrial Enquiries
  {
    ...
    leadId: "TT-IND-2026-001",
    submittedAt: "03/09/2026, 4:44:00 pm",
  ...
  // 6. Career Applications
  {
    ...
    leadId: "TT-CAR-2026-001",
    submittedAt: "03/09/2026, 4:45:00 pm",
  ...
  // 7. Robotics Club Applications
  {
    ...
    leadId: "TT-CLB-2026-001",
    submittedAt: "03/09/2026, 4:46:00 pm",
    name: "Dharun Kumar",
  ...
  // 8. Contact & Inquiries
  {
    ...
    leadId: "TT-CNT-2026-001",
    submittedAt: "03/09/2026, 4:47:00 pm",
    name: "Vigneshwaran P",
  ...
  // 9. Newsletters
  {
    ...
    leadId: "TT-NWL-2026-001",
    submittedAt: "03/09/2026, 4:48:00 pm",
...
async function run() {
  console.log(`Pushing 1 sample record to all ${MOCK_DATA.length} tabs...`);

  for (const item of MOCK_DATA) {
    console.log(`\n==> Pushing to [${item.sheetName}] (ID: ${item.leadId})...`);
    try {
      ...
      console.log(`Result for ${item.sheetName}:`, json);
    } catch (err) {
      console.error(`Error for ${item.sheetName}:`, err.message);
    }
  }

  console.log("\nAll 9 mock data rows pushed successfully!");
}
