...
export type MarketingEventName =
  ...
  | "service_page_view"
  | "service_quote_open"
  | "service_quote_submit"
  | "service_whatsapp_click"
  | "service_contact_click"
  | "service_faq_open"
  | "service_related_service_click"
  | "service_related_product_click"
  | "solution_page_view"
  | "solution_needs_select"
  | "solution_quote_open"
  | "solution_quote_submit"
  | "solution_whatsapp_click"
  | "solution_contact_click"
  | "solution_related_service_click"
  | "solution_related_product_click"
  | "solution_related_course_click"
  | "solution_faq_open"
  | "product_list_view"
  | "product_category_view"
  | "product_configuration_select"
  | "product_enquiry_open"
  | "product_enquiry_submit"
  | "product_whatsapp_click"
  | "product_talk_engineer_click"
  | "product_related_service_click"
  | "product_related_product_click"
  | "product_related_course_click"
  | "product_related_project_click"
  | "product_faq_open"
  | "product_spec_tab_click"
  | "project_list_view"
  | "project_category_view"
  | "project_view"
  | "project_filter"
  | "project_discuss_open"
