    ...
    <div className="bg-white pt-32 pb-24 selection:bg-[#FF6B00] selection:text-white min-h-screen text-[#111111] text-left">
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="mb-16 border-l-4 border-[#FF6B00] pl-6 py-2">
          <h1 className="text-[10px] font-black text-[#FF6B00] uppercase tracking-[0.6em] mb-4 font-sans">Entity Profile Page</h1>
          <h2 className="text-3xl md:text-5xl font-black uppercase text-[#111111] tracking-tighter leading-none">About Tamizh Tech Robotics</h2>
          <p className="text-gray-500 font-bold uppercase mt-3 text-xs tracking-wider">Target: Robotics Company in Tamil Nadu</p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section className="space-y-4">
            <h3 className="text-lg font-black uppercase text-[#111111] tracking-tight">1. Who are we?</h3>
          ...
          <section className="space-y-4">
            <h3 className="text-lg font-black uppercase text-[#111111] tracking-tight">2. What do we do?</h3>
            <p className="text-gray-600 text-sm font-medium leading-relaxed uppercase tracking-tight">
            ...
            <ul className="space-y-3 pl-4">
              <li className="flex items-start gap-2.5 text-xs text-gray-600 font-bold uppercase tracking-wider">
                <Check className="w-4 h-4 text-[#FF6B00] shrink-0 mt-0.5" /> <strong>Robotics Hardware:</strong> Manufacturing competition bots (Robo Race, Soccer, War, Sumo), RC boats, and sensor kits.
              </li>
              <li className="flex items-start gap-2.5 text-xs text-gray-600 font-bold uppercase tracking-wider">
                <Check className="w-4 h-4 text-[#FF6B00] shrink-0 mt-0.5" /> <strong>Academic Lab Setup:</strong> Setting up STEM labs, robotics labs, and AI labs in school and college campuses.
              </li>
              <li className="flex items-start gap-2.5 text-xs text-gray-600 font-bold uppercase tracking-wider">
                <Check className="w-4 h-4 text-[#FF6B00] shrink-0 mt-0.5" /> <strong>B2B Factory Automation:</strong> Programming PLCs/SCADA systems, deploying AMRs, and installing OpenCV machine vision inspection cells.
              </li>
            </ul>
          </section>

          <section className="space-y-4">
            <h3 className="text-lg font-black uppercase text-[#111111] tracking-tight">3. Who do we help?</h3>
            <p className="text-gray-600 text-sm font-medium leading-relaxed uppercase tracking-tight">
          ...
          <section className="space-y-4">
            <h3 className="text-lg font-black uppercase text-[#111111] tracking-tight">4. Why are we trusted?</h3>
            <p className="text-gray-600 text-sm font-medium leading-relaxed uppercase tracking-tight">
          ...
          <section className="space-y-4">
            <h3 className="text-lg font-black uppercase text-[#111111] tracking-tight">5. What makes us different?</h3>
            <p className="text-gray-600 text-sm font-medium leading-relaxed uppercase tracking-tight">
        ...
        {/* Lead Capture Box */}
        <div className="p-8 bg-[#FFF2E6] border border-[#FF6B00]/20 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6 mt-16">
          <div>
            <h4 className="text-base font-black uppercase text-[#111111] tracking-tight">Connect with Tamil Nadu's Robotics Leader</h4>
            <p className="text-xs text-gray-500 font-bold uppercase mt-1">Book an on-site lab demonstration or request a pricing sheet.</p>
          </div>
