    ...
    <div className="bg-white pt-32 pb-24 selection:bg-[#FF6B00] selection:text-white min-h-screen text-[#111111] text-left">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mb-20 border-l-4 border-[#FF6B00] pl-6 md:pl-10 py-4">
          <h1 className="text-[10px] font-black text-[#FF6B00] uppercase tracking-[0.6em] mb-6 font-sans">Engineering Solutions</h1>
          ...
          {[
            ...
            <div key={idx} className="bg-[#FAFAFA] border border-[#E5E5E5] p-8 rounded-2xl hover:border-[#FF6B00] transition-colors flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-lg font-black uppercase text-[#111111] tracking-tight mb-2">{item.title}</h3>
                <p className="text-xs text-gray-500 font-bold uppercase leading-relaxed">{item.desc}</p>
              </div>
            </div>
          ))}
        </section>
        ...
        <section className="max-w-4xl mx-auto mb-24" id="colleges-form">
          <div className="border border-[#E5E5E5] rounded-2xl bg-[#FAFAFA] p-8 md:p-12 text-left relative overflow-hidden">
            ...
            <span className="text-[9px] font-black text-[#FF6B00] uppercase tracking-[0.3em] mb-3 block">Research Tie-up</span>
            <h3 className="text-2xl md:text-3xl font-black uppercase text-[#111111] tracking-tighter mb-4">Request R&D Collaboration & Quote</h3>
            <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mb-8">Elevate your institution's technical rating. Fill in the details to register your requirement for research setup quotes or workshop sponsorships.</p>
            
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label className="text-[9px] font-black text-gray-400 uppercase tracking-wider font-sans">Representative Name & Title</label>
                  <input required type="text" placeholder="Dr. Rajkumar (HOD, Mechatronics)" className={formInputClass} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[9px] font-black text-gray-400 uppercase tracking-wider font-sans">Department Email Coordinate</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="flex flex-col gap-2">
                  <label className="text-[9px] font-black text-gray-400 uppercase tracking-wider font-sans">Mobile / Direct Phone</label>
                  <input required type="text" placeholder="+91 XXXXX XXXXX" className={formInputClass} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[9px] font-black text-gray-400 uppercase tracking-wider font-sans">Institution Name & Address</label>
                  <input required type="text" placeholder="PSG College of Technology, Coimbatore" className={formInputClass} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[9px] font-black text-gray-400 uppercase tracking-wider font-sans">Interest Category</label>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[9px] font-black text-gray-400 uppercase tracking-wider font-sans">Project Details / Component List</label>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                >
                  <FaWhatsapp className="w-4 h-4 text-[#FF6B00]" /> Fast College WhatsApp Desk
                </a>
              </div>
            </form>
          </div>
        ...
        <section className="max-w-4xl mx-auto mb-24">
          <div className="text-center mb-12">
            <span className="text-[10px] font-black text-[#FF6B00] uppercase tracking-[0.4em] mb-2 block">Institutional Support</span>
            <h3 className="text-2xl font-black uppercase text-[#111111] tracking-tighter">Academic Program FAQs</h3>
          </div>
