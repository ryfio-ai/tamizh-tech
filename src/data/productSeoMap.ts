...
export const productSeoMap: Record<string, ProductSeoEntry> = {
  ...
  "rc-robo-soccer": {
    ...
    longTailKeywords: [
      ...
      "TTRC RS-5.0 robo soccer platform for robotics tournaments",
    ...
    questionKeywords: [
      "What is TTRC RS-5.0 Robo Soccer?",
      "What motors power the TTRC Robo Soccer bot?",
      "What wheel sizes fit the TTRC RS-5.0 soccer platform?",
